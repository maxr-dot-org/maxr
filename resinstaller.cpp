...
void showIntroduction ()
{
	...
	cout << strAbout1 << endl;
	cout << strAbout2 << endl;
	cout << strAbout3 << endl << endl;
	cout << strGPL1 << endl;
	cout << strGPL2 << endl;
	cout << strGPL3 << endl;
	cout << strGPL4 << endl << endl;
	cout << strGPL5 << endl;
	cout << strGPL6 << endl;
	cout << strGPL7 << endl;
	cout << strGPL8 << endl << endl;
#endif
}
...
bool validateMAXPath (string& maxPath)
{
	...
	try
	{
		res = openFile ( (maxPath + PATH_DELIMITER + "MAX.RES").c_str(), "rb" );
		maxPath += PATH_DELIMITER;
		return true;
	}
	...
	try
	{
		res = openFile ( (maxPath + "MAX" + PATH_DELIMITER + "MAX.RES").c_str(), "rb" );
		maxPath = maxPath + "MAX" + PATH_DELIMITER;
		return true;
	}
	catch ( InstallException ) {}
	...
	try
	{
		res = openFile ( (maxPath + PATH_DELIMITER + "MAX" + PATH_DELIMITER + "MAX.RES").c_str(), "rb" );
		maxPath = maxPath + PATH_DELIMITER + "MAX" + PATH_DELIMITER;
		return true;
	}
	catch ( InstallException ) {}
...
{	
	...
	pathFromUser = askForCDPath (validateMAXPath); 
...
bool validateOutputPath (string& outputPath)
{
	...
	try
	{
		testFile = openFile( outputPath + testFileName, "r");
	...
	try
	{
		testFile = openFile( outputPath + PATH_DELIMITER + testFileName, "r");
		outputPath += PATH_DELIMITER;
		SDL_RWclose( testFile );
		return true;
	}
	catch ( InstallException ) {}
...
string getOutputPathFromUser (string cmdLineOutputPath)
{
	...
	pathFromUser = askForOutputPath (validateOutputPath); 
