...
#ifndef game_data_reports_special_savedreportplayerendedturnH
#define game_data_reports_special_savedreportplayerendedturnH

#include "game/data/report/savedreport.h"

class cPlayer;

class cSavedReportPlayerEndedTurn : public cSavedReport
{
public:
...
#endif // game_data_reports_special_savedreportplayerendedturnH
