...
{
public:
	cSavedReportPlayerDefeated (const cPlayer& player);
	explicit cSavedReportPlayerDefeated (cNetMessage& message);
	explicit cSavedReportPlayerDefeated (const tinyxml2::XMLElement& element);
