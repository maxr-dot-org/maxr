...
#ifndef game_data_reports_savedreportattackedH
#define game_data_reports_savedreportattackedH
...
public:
	...
	explicit cSavedReportAttacked (cNetMessage& message);
	explicit cSavedReportAttacked (const tinyxml2::XMLElement& element);
