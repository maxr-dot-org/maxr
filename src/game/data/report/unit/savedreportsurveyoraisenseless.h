...
#ifndef game_data_reports_savedreportsurveyoraisenselessH
#define game_data_reports_savedreportsurveyoraisenselessH
...
class cSavedReportSurveyorAiSenseless : public cSavedReportUnit
{
public:
...
#endif // game_data_reports_savedreportsurveyoraisenselessH
