...
#ifndef ui_graphical_game_widgets_mousemode_mousemodetransferH
#define ui_graphical_game_widgets_mousemode_mousemodetransferH
...
{
public:
	cMouseModeTransfer (const cMap* map, const cUnitSelection& unitSelection, const cPlayer* player);
...
#endif // ui_graphical_game_widgets_mousemode_mousemodetransferH
