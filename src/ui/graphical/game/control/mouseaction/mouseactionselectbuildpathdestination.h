...
#ifndef ui_graphical_game_control_mouseaction_mouseactionselectbuildpathdestinationH
#define ui_graphical_game_control_mouseaction_mouseactionselectbuildpathdestinationH
