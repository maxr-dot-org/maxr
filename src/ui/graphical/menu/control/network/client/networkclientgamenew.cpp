...
//------------------------------------------------------------------------------
void cNetworkClientGameNew::start (cApplication& application, std::shared_ptr<cStaticMap> staticMap, std::shared_ptr<cClient> client, const sInitPlayerData& initPlayerData)
{
