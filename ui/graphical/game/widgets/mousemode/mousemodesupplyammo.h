...
#ifndef ui_graphical_game_widgets_mousemode_mousemodesupplyammoH
#define ui_graphical_game_widgets_mousemode_mousemodesupplyammoH
...
{
public:
	cMouseModeSupplyAmmo (const cMap* map, const cUnitSelection& unitSelection, const cPlayer* player);
...
#endif // ui_graphical_game_widgets_mousemode_mousemodesupplyammoH
