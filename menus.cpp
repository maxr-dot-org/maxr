...
bool cNetworkHostMenu::runSavedGame()
{
	...
	// exit menu and start game
	server.serverState = SERVER_STATE_INGAME;
	client->getGameGUI().show (client.get());
	...
	, client (&client_)
{
	...
	typeButtonGroup->addButton (new cMenuCheckButton (position.x + 524, position.y + 71 + 29, lngPack.i18n ("Text~Others~Disadvantages_8cut"), false, false, cMenuCheckButton::RADIOBTN_TYPE_ANGULAR_BUTTON));
