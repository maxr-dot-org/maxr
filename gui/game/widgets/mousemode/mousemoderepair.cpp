...
#include "mousemoderepair.h"
#include "../mouseaction/mouseactionrepair.h"
...
bool cMouseModeRepair::canExecuteAction (const cMap& map, const cPosition& mapPosition, const cUnitSelection& unitSelection) const
{
	...
	return selectedVehicle && selectedVehicle->canSupply (map, mapPosition.x (), mapPosition.y (), SUPPLY_TYPE_REPAIR);
}